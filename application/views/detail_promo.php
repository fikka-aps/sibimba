    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container text-center">
                <div class="card">
                    <img src="<?= base_url('img/promo/') . $detail['image']; ?>" width="700px" class="img mx-auto mt-5 mb-5" alt="...">
                    <div class="card-body">
                        <h2 class="card-title"><?= $detail['promo'] ?></h2>
                        <p class="card-text"><?= $detail['description'] ?></p>
                    </div>
                    <div class="card-body">
                        <li class="list-group-item">Bimbel : <br> <a href="<?= base_url('detail/') . $detail['bimbel_id']; ?>" class="card-link"><?= $detail['bimbel_name'] ?></a></li>
